...
import { Mail, Zap, Video, Sparkles, Check, Globe, Mic, Users, Film } from 'lucide-react';
...
export default function WaveifyLanding() {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://console.waveify.ai/customers/subscribe', {
        method: 'POST',
        headers: {
      ...
      // Show success message even on error for UX
      setIsSubmitted(true);
      setName('');
      setEmail('');
      setTimeout(() => {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Just type your script and let Waveify.ai handle the rest. Get professional, vertical videos optimized for Instagram Reels and TikTok in minutes.
            </p>
            <button
